...
public class EnemyLookAndRotate2Esp : MonoBehaviour
{
    ...
    void Update()
    {
        if (!isPaused)
        {
            ...
            // Use PingPong to calculate the rotation angle between 0 and 45
            float angle = Mathf.PingPong(elapsedTime * rotationSpeed, rotationAngle);
