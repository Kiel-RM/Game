...
public class PlayerMovementJack : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        if (horizontalInput != 0)
        {
            ...
            animator.SetBool("Correr", true); // Activa la animaci�n de correr
            animator.SetBool("Standing", false); // Desactiva la animaci�n de estar parado
        }
        else
        {
            animator.SetBool("Correr", false); // Desactiva la animaci�n de correr
            animator.SetBool("Standing", true); // Activa la animaci�n de estar parado
        }
    }
